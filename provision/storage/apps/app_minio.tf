      ...
      spec {
        container {
          ...
          env {
            ...
            value = "http://minio.homehaven.work,http://s3.homehaven.work"
          }
          env {
            name  = "MINIO_BROWSER_REDIRECT_URL"
            value = "http://minio.homehaven.work"
          }
          env {
          ...
          env {
            ...
            value = "https://prometheus.alpheon.uk"
          }
          env {
